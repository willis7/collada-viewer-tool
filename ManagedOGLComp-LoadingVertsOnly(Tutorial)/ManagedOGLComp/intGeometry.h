...
#include "MyGeometry.h" //this is my user defined class!
...
private: // USER CODE
	MyGeometry* _object; //holds our geometry object
	daeElement* _element; //element which is associated with that object
